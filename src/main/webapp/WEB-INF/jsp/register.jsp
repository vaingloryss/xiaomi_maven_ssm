...
<script type="text/javascript">
	$(function(){
		$("#username").change(function(){
			...
			$.post("${pageContext.request.contextPath}/userController/checkUsername","username="+this.value,function(data){
				if(data=="1"){
	...
	<div class="regist">
		<div class="regist_center">
			<div class="regist_top">
				...
				<div class="right fr">
					<a href="home.jsp" target="_black">小米商城</a>
				</div>
				<div class="clear"></div>
				<div class="xian center"></div>
			</div>
			<div class="center-block" style="margin-top: 80px;">
				<form id="form1" class="form-horizontal" action="${pageContext.request.contextPath}/userController/register" method="post">
