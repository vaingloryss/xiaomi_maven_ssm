...
<head>
	...
	<script type="text/javascript">
		...
		function loadUser(){
			$.ajax({
				url:"${pageContext.request.contextPath}/adminController/getUserList?flag=2",
				method:"get",
		...
		function showMsg(data){
			...
			for(var u in data){
				...
				var td6 = $("<td><a href='javascript:delUser("+data[u].id+")' class='btn btn-primary btn-xs'>彻底删除</a></td>");
		...
		function delUser(id){
			if(confirm("确认要删除吗 ? 删除后不可恢复！")){
				$.ajax({
					url:"${pageContext.request.contextPath}/userManage?op=deleteUser&id="+id,
					method:"get",
					success:function(data){
						loadUser();
					},
