...
<head>
	...
	<script type="text/javascript">
		...
		function clearCart(){
			if(confirm("确定要清空吗")){
				$.ajax({
					url:"${pageContext.request.contextPath}/cartController/clearCart",
					method:"get",
					success:function(){
						location.href = "${pageContext.request.contextPath}/cartController/showCart";
					},
	...
	<div class="row">
		<div class="pull-right" style="margin-right: 40px;">
			...
			<div>
				...
				&nbsp;&nbsp;
				<a href="${pageContext.request.contextPath}/orderController/getOrderView" class="btn  btn-danger btn-lg">结账</a>
