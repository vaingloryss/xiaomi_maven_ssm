	...
	<div class="row" style="width: 30%;margin: 0 auto;padding-top: 20px">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<hr>
				<a href="${pageContext.request.contextPath}/cartController/showCart" class="btn btn-primary">查看购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${pageContext.request.contextPath}/userController/toHome" class="btn btn-default">继续购物</a>
			</div>
		</div>
