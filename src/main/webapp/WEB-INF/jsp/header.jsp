...
<script type="text/javascript">
	$(document).ready(function(){
		$.ajax({
			...
			success:function(data){
				for(var i in data){
					var a = $("<a href='${pageContext.request.contextPath}/goodsController/miGaming?typeId="+data[i].id+"'>"+data[i].name+"</a>");
					$("#goodsType").append(a);
				}
			},
			dataType:"json",
 ...
 <div id="top">
    	<div id="topdiv">
            <span>
                <a href="home.jsp" id="a_top" target="_blank">小米商城</a>
                <li>|</li>
            ...
            <span style="float:right">
       			...
       			<c:if test="${not empty user}">
       				<a href="${pageContext.request.contextPath}/addressController/showAddress" id="a_top">${user.username}</a>
       				<li>|</li>
