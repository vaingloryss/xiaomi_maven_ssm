...
<script type="text/javascript">
	function showOrder(orderId){
		location.href="${pageContext.request.contextPath}/orderController/orderDetail?oid="+orderId;
	}
	function changeStatus(orderId){
		location.href="${pageContext.request.contextPath}/orderServlet?op=confirmReceipt&oid="+orderId;
	}
</script>
</head>
...
<div class="container" style="background-color: white;">
	<div class="row" style="margin-left: 40px">
		<h3>我的订单列表&nbsp;&nbsp;
		<small>温馨提示：<em>${user.username}</em>有<font color="red">${orders.size()}</font>个订单</small></h3>
	</div>
