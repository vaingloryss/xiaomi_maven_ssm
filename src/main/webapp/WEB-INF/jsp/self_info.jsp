...
<script type="text/javascript">
	function deleteAddr(id){
		...
		if(res==true){
			window.location.href="${pageContext.request.contextPath}/addressController/deleteAddress?aid="+id;
		}
	}
	function defaultAddr(id){
		var res = confirm("是否设为默认");
		if(res==true){
			window.location.href="${pageContext.request.contextPath}/addressController/defaultAddress?aid="+id;
		}
	}
</script>
</head>
